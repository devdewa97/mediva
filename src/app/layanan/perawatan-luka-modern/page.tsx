...
const services = [
  ...
  { icon: Activity, title: "Layanan Konsultasi", desc: "Konsultasi pra-perawatan untuk menilai dan rencana penanganan." },
];
        ...
        <div className="relative z-10 w-full">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="flex items-center gap-2 text-white/80 text-sm mb-8">
              <a href="/">Beranda</a><span>/</span><a href="#layanan">Layanan</a><span>/</span><span className="text-white">Perawatan Luka Modern</span>
            </div>

            <div className="grid md:grid-cols-2 gap-12 items-start">
              {/* Left Column - Title, Description & Stats */}
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">Perawatan Luka dengan Pendekatan Modern & Steril</h1>
                <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mb-8">Perawatan luka modern di Klinik Griya Luka Mediva mengadopsi prinsip evidence-based wound care dengan teknologi terbaru untuk hasil penyembuhan optimal.</p>
              ...
              {/* Right Column - 5 Items about Quick Recovery */}
              <div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1">Teknologi Modern</h4>
                        <p className="text-white/80 text-sm">Peralatan medis terkini untuk penyembuhan optimal</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1">Metode Steril</h4>
                        <p className="text-white/80 text-sm">Protokol steril ketat untuk minimalkan risiko infeksi</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1">Tim Medis Profesional</h4>
                        <p className="text-white/80 text-sm">Tenaga kesehatan berpengalaman dan tersertifikasi</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1">Monitoring Rutin</h4>
                        <p className="text-white/80 text-sm">Follow up berkala untuk pemulihan cepat</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1">Pendekatan Komprehensif</h4>
                        <p className="text-white/80 text-sm">Perawatan holistik untuk kesembuhan total</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-white border border-slate-200 shadow-sm px-5 py-2 rounded-full mb-6">
              ...
              <span className="text-slate-600 text-sm font-medium tracking-wide">Layanan Kami</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">Layanan Perawatan Luka yang Kami Sediakan</h2>
            <p className="text-slate-500 max-w-xl mx-auto text-lg">Berbagai layanan komprehensif untuk kebutuhan perawatan luka Anda dengan standar medis internasional</p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800">Momen Perawatan Luka</h2>
            <p className="text-slate-500 mt-3 max-w-2xl mx-auto">Dokumentasi aktivitas layanan perawatan luka modern kami dalam memberikan pelayanan terbaik untuk kesembuhan pasien.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group relative overflow-hidden rounded-2xl aspect-[4/3] shadow-lg hover:shadow-2xl transition-all duration-300">
              <img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=600&q=80" alt="Peralatan Modern" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="font-semibold">Peralatan Modern</p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl aspect-[4/3] shadow-lg hover:shadow-2xl transition-all duration-300">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="font-semibold">Konsultasi Pasien</p>
              </div>
            </div>
            <div className="group relative overflow-hidden rounded-2xl aspect-[4/3] shadow-lg hover:shadow-2xl transition-all duration-300">
              <img src="https://images.unsplash.com/photo-1584820927498-cfe5211fd8bf?w=600&q=80" alt="Luka Diabetes" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <div className="group relative overflow-hidden rounded-2xl aspect-[4/3] shadow-lg hover:shadow-2xl transition-all duration-300">
              <img src="https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=600&q=80" alt="Monitoring" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              <div className="absolute bottom-4 left-4 right-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <p className="font-semibold">Monitoring Berkala</p>
              </div>
            </div>
          </div>
        </div>
