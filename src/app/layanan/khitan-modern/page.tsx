...
const features = [
  { icon: Activity, title: "Prosedur Khitan Minim Rasa Sakit", desc: "Metode anestesi lokal avanzadas untuk meminimalkan rasa sakit selama prosedur, nyaman untuk anak." },
  { icon: Scissors, title: "Metode Khitan Modern", desc: "Penggunaan teknik khitan terkini dengan peralatan medis steril untuk hasil maksimal." },
  { icon: User, title: "Tenaga Medis Berpengalaman", desc: "Tim dokter dan perawat tersertifikasi dengan pengalaman bertahun-tahun." },
  { icon: HeartPulse, title: "Perawatan Pasca Khitan", desc: "Panduan perawatan luka komprehensif dan follow up untuk pemulihan cepat." },
  { icon: FileText, title: "Konsultasi Pra Khitan", desc: "Pemeriksaan kesehatan pra-prosedur untuk memastikan kesiapan pasien." },
  { icon: Shield, title: "Fasilitas Nyaman dan Aman", desc: "Ruang tindakan bersih, steril, dan nyaman dengan standar medis tinggi." },
  { icon: Users, title: "Edukasi dan Dukungan untuk Keluarga", desc: "Pelatihan keluarga tentang perawatan pasca khitan di rumah." },
];
    ...
    <>
        ...
        <div className="relative z-10 w-full">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="flex items-center gap-2 text-white/80 text-sm mb-8">
              <a href="/">Beranda</a><span>/</span><a href="#layanan">Layanan</a><span>/</span><span className="text-white">Khitan Modern</span>
            </div>

            <div className="grid md:grid-cols-2 gap-12 items-start">
              {/* Left Column - Title, Description & Stats */}
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">Pelayanan Khitan Modern yang Aman, Nyaman, dan Minim Rasa Sakit</h1>
                <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mb-8">Khitan modern di Klinik Griya Luka Mediva dilakukan dengan metode terkini yang mengutamakan kenyamanan pasien, prosedur steril, serta penanganan oleh tenaga medis berpengalaman. Pendekatan ini membuat proses khitan lebih cepat, minim rasa sakit, dan pemulihan lebih optimal.</p>

                {/* Stats - 3 Column Grid */}
                <div className="grid grid-cols-3 gap-4 pt-6 border-t border-white/20">
                  <div className="text-center">
                    <p className="text-2xl md:text-3xl font-bold text-white">99%</p>
                    <p className="text-white/80 text-sm">Pasien Puas</p>
                  </div>
                  <div className="text-center">
              ...
              {/* Right Column - 7 Items Cards */}
              <div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                  <h3 className="text-xl font-bold text-white mb-6 text-center">
                    Layanan Khitan Modern
                  </h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm">Prosedur Khitan Minim Rasa Sakit</h4>
                        <p className="text-white/70 text-xs">Metode anestesi lokal avanzada</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm">Metode Khitan Modern</h4>
                        <p className="text-white/70 text-xs">Teknik terkini dengan peralatan steril</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm">Tenaga Medis Berpengalaman</h4>
                        <p className="text-white/70 text-xs">Tim tersertifikasi bertahun-tahun</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm">Perawatan Pasca Khitan</h4>
                        <p className="text-white/70 text-xs">Panduan dan follow up komprehensif</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm">Konsultasi Pra Khitan</h4>
                        <p className="text-white/70 text-xs">Pemeriksaan kesehatan pra-prosedur</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm">Fasilitas Nyaman dan Aman</h4>
                        <p className="text-white/70 text-xs">Ruang tindakan steril & nyaman</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 p-3 bg-white/10 rounded-xl">
                      ...
                      <div>
                        <h4 className="text-white font-semibold mb-1 text-sm">Edukasi dan Dukungan Keluarga</h4>
                        <p className="text-white/70 text-xs">Pelatihan perawatan di rumah</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">Standar Medis Tinggi untuk Kenyamanan Pasien</h2>
            <p className="text-slate-500 max-w-xl mx-auto text-lg">Klinik Griya Luka Mediva mengutamakan standar medis tertinggi dalam setiap prosedur khitan, memastikan keamanan dan kenyamananoptimal untuk pasien anak maupun dewasa.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.slice(0, 6).map((s, i) => {
              const Icon = s.icon;
              return (
                <div key={i} className="group relative bg-white/80 backdrop-blur-sm border border-slate-200/80 rounded-2xl p-7 shadow-sm hover:shadow-xl hover:border-[#208300]/30 hover:-translate-y-1 transition-all duration-300 cursor-pointer overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <h3 className="text-lg font-bold text-slate-800 mb-3 leading-snug group-hover:text-[#208300] transition-colors duration-300">{s.title}</h3>
      ...
      <section className="py-24 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-slate-800">Momen Khitan Modern</h2>
            <p className="text-slate-500 mt-3 max-w-2xl mx-auto">Dokumentasi aktivitas layanan khitan modern kami dalam memberikan pelayanan terbaik untuk keluarga.</p>
          </div>
      ...
      <section id="kontak" className="py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Konsultasikan Kesehatan Anda Sekarang</h2>
          <p className="text-lg text-white/90 mb-10 max-w-2xl mx-auto">Tim medis profesional siap memberikan konsultasi dan rencana perawatan terbaik untuk kebutuhan khitan Anda.</p>
