      ...
      <section id="layanan" className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            ...
            <div className="flex flex-col h-full bg-white rounded-2xl border border-slate-200/70 shadow-sm hover:shadow-md transition-all">
              <div className="h-1 bg-[#208300] rounded-t-2xl"></div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="inline-flex items-center bg-transparent border-2 border-white text-white px-8 py-5 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all hover:shadow-xl backdrop-blur-sm"
            >
