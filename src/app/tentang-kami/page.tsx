        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group relative bg-white rounded-2xl border border-slate-200/70 shadow-sm hover:shadow-xl hover:border-[#208300]/30 transition-all duration-300 overflow-hidden flex flex-col">
              ...
              <div className="px-6 pb-6 pt-4 mt-auto border-t border-slate-100">
                <span className="text-xs text-[#208300] font-semibold cursor-pointer">Selengkapnya</span>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-[#208300] to-[#166600] rounded-2xl shadow-lg overflow-hidden flex flex-col">
              ...
              <div className="relative px-6 pb-6 pt-4 mt-auto border-t border-white/20">
                <span className="text-xs text-white font-semibold cursor-pointer">Selengkapnya</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                <a
                  ...
                  className="inline-flex items-center bg-white text-[#208300] px-8 py-5 rounded-2xl font-bold text-lg hover:bg-slate-100 transition-all hover:shadow-xl group"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center bg-transparent border-2 border-white text-white px-8 py-5 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all"
                >
